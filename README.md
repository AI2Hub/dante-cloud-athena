...
在 Spring Security OAuth2 彻底停止维护、Spring Boot 2.7.1 正式发布之时，又恰逢 Eurynome Cloud 开源一周年之际，推出基于 Spring Authorization Server 0.3.1、Spring Boot 2.7.1、Spring Cloud 2021.0.3、Spring Cloud Alibaba 2021.0.1.0 和 Nacos 2.1.0 的全新正式版本。细节满满，欢迎品鉴。
